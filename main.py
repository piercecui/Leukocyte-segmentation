...
def train_model(model,criterion,optimizer,scheduler,dataload,num_epochs=10):
...
def train():
    ...
    cell_dataset = CellDataset("/Users/pierce/Desktop/summer internship/learning/whitecell/sharpen_train", transform=x_transform, target_transform=y_transform)
...
def test():
    ...
    cell_dataset = CellDataset("/Users/pierce/Desktop/summer internship/learning/whitecell/sharpen_test", transform=x_transform, target_transform=y_transform)
